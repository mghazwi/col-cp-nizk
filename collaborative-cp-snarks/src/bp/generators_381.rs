...
//! non-generic generators -> works over ark_bls12_381
...
impl Iterator for GeneratorsChain {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        Some((G::generator()*s).into_affine())
    }
