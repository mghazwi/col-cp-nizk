...
use crate::bp::inner_product_proof_381::inner_product;
use crate::bp::r1cs::prover::custom_msm_iter;
...
impl<'t, 'g> Verifier<'t, 'g> {
    ...
    pub fn commit(&mut self, commitment: G) -> Variable {
        let i = self.V.len();
    ...
    pub fn verify(mut self, proof: &R1CSProof, bp_gens: &BulletproofGens) -> Result<(), R1CSError> {
        ...
        let bases = iter::once(proof.A_I1)
