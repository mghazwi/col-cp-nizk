use super::{r1cs_to_qap::R1CSToQAP, Groth16, Proof, ProvingKey, VerifyingKey};
    ...
    E: MpcPairingTrait<B>,
{
    ...
    fn create_proof_with_assignment(
        ...
        // let l_aux_acc = E::G1::msm(&pk.l_query, &aux_assignment);
    ...
    pub fn rerandomize_proof(
        ...
        while r1.is_zero() || r2.is_zero() {
            r1 = <E as MpcPairingTrait<B>>::ScalarField::rand(rng);
            r2 = <E as MpcPairingTrait<B>>::ScalarField::rand(rng);
        }
